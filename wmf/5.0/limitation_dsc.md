...
**Lösung:** Importieren Sie die erforderliche Version, indem Sie das *ModuleSpecification*-Objekt wie folgt mit dem `RequiredVersion`-Schlüssel in `-ModuleName` definieren:
