...
translationtype: HT
---
# <a name="install-and-configure-wmf-51-preview"></a>Installieren und Konfigurieren von WMF 5.1 (Preview) #

## <a name="install-net-46"></a>Installieren von .NET 4.6
...
## <a name="download-and-install-the-wmf-51-preview"></a>Herunterladen und Installieren von WMF 5.1 Preview
...
## <a name="install-wmf-51-from-windows-explorer-or-file-explorer-in-windows-server-2012-r2-or-windows-81"></a>Installieren von WMF 5.1 über den Windows-Explorer (bzw. Datei-Explorer in Windows Server 2012 R2 und Windows 8.1)
...
## <a name="install-wmf-51-from-the-command-prompt"></a>Installieren von WMF 5.1 über die Eingabeaufforderung##
...
Für die Installation von WMF 5.1 unter Windows Server 2008 R2 SP1 oder Windows 7 SP1 muss Folgendes installiert sein:
