...
Der Ordner zum Sichern des Benutzerlaufwerks wird in folgendem Verzeichnis erstellt: `$env:LOCALAPPDATA\Microsoft\Windows\PowerShell\DriveRoots\DOMAIN_USER`
