...
---
# <a name="bootstrap-both-nuget-provider-and-nugetexe-or-bootstrap-only-nuget-provider"></a>Bootstrapping des NuGet-Anbieters und von „NuGet.exe“ oder ausschließliches Bootstrapping des NuGet-Anbieters
