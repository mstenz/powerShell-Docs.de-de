...
### <a name="update-the-module-with-a-prerelease-version-requires--allowprerelease-flag"></a>Aktualisieren des Moduls mit einer Vorabversion mit dem erforderlichen -AllowPrerelease-Flag
```powershell
PS C:\windows\system32> Get-InstalledModule
Version Name Repository Description
------- ---- ---------- -----------
