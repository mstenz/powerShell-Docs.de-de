...
---
# <a name="uninstall-script"></a><span data-ttu-id="9fdbe-103">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="9fdbe-103">Uninstall-Script</span></span>

<span data-ttu-id="9fdbe-104">Deinstalliert eine Skriptdatei, die mithilfe von PowerShellGet installiert wurde</span><span class="sxs-lookup"><span data-stu-id="9fdbe-104">Uninstalls a script file which was installed using PowerShellGet.</span></span>

## <a name="description"></a><span data-ttu-id="9fdbe-105">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="9fdbe-105">Description</span></span>

<span data-ttu-id="9fdbe-106">Das Cmdlet „Uninstall-Script“ deinstalliert die angegebenen Skriptdateien, die aus dem Online-Repository installiert wurden.</span><span class="sxs-lookup"><span data-stu-id="9fdbe-106">The Uninstall-Script cmdlet uninstalls the specified script files which were installed from the online repository.</span></span>

## <a name="cmdlet-syntax"></a><span data-ttu-id="9fdbe-107">Cmdlet-Syntax</span><span class="sxs-lookup"><span data-stu-id="9fdbe-107">Cmdlet syntax</span></span>

```powershell
Get-Command -Name Uninstall-Script -Module PowerShellGet -Syntax
```
## <a name="cmdlet-online-help-reference"></a><span data-ttu-id="9fdbe-108">Cmdlet-Onlinehilfe</span><span class="sxs-lookup"><span data-stu-id="9fdbe-108">Cmdlet online help reference</span></span>

[<span data-ttu-id="9fdbe-109">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="9fdbe-109">Uninstall-Script</span></span>](http://go.microsoft.com/fwlink/?LinkId=619789)

## <a name="example-commands"></a><span data-ttu-id="9fdbe-110">Beispiele für Befehle</span><span class="sxs-lookup"><span data-stu-id="9fdbe-110">Example commands</span></span>
