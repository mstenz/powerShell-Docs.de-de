...
---
# <a name="role-based-authorization-configuration-schema"></a>Konfigurationsschema für die rollenbasierte Autorisierung

Das Beispiel " [ptauscht srolebasedplugins](https://go.microsoft.com/fwlink/?LinkId=243041) " verwendet XML-Dateien, um die Autorisierungs Richtlinie zu konfigurieren. Die folgende XSD definiert das Schema, das für diese Dateien verwendet wird.
