...
Die [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) Beispiel verwendet XML-Dateien, um die Konfiguration der Autorisierungsrichtlinie für. Das folgende XSD definiert das Schema für diese Dateien verwendet.
