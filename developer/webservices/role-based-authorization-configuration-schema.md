...
ms.locfileid: "56862566"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="4184a-102">Konfigurationsschema für die rollenbasierte Autorisierung</span><span class="sxs-lookup"><span data-stu-id="4184a-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="4184a-103">Die [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) Beispiel verwendet XML-Dateien, um die Konfiguration der Autorisierungsrichtlinie für.</span><span class="sxs-lookup"><span data-stu-id="4184a-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="4184a-104">Das folgende XSD definiert das Schema für diese Dateien verwendet.</span><span class="sxs-lookup"><span data-stu-id="4184a-104">The following XSD defines the schema used for these files.</span></span>
