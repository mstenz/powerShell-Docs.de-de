---
title: Ressource Zuordnungsschema | Microsoft-Dokumentation
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56862696"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="19265-102">Schema für Ressourcenzuordnung</span><span class="sxs-lookup"><span data-stu-id="19265-102">Resource Mapping Schema</span></span>

<span data-ttu-id="19265-103">Management OData IIS-Erweiterung verwendet XML-Dateien, um die Zuordnung zu definieren.</span><span class="sxs-lookup"><span data-stu-id="19265-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="19265-104">Das folgende XSD definiert das Schema für diese Dateien verwendet.</span><span class="sxs-lookup"><span data-stu-id="19265-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="19265-105">Der Zuordnungsdatei XSD-Ressourcen</span><span class="sxs-lookup"><span data-stu-id="19265-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="19265-106">Das folgende XSD definiert das Schema für Zuordnungsdateien für Management OData IIS-Erweiterung-Ressource.</span><span class="sxs-lookup"><span data-stu-id="19265-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
