...
Nachdem Sie alle die erforderlichen Schritte zum Erstellen eines Management OData-Webdiensts haben, müssen Sie es als eine Webanwendung in IIS bereitstellen.

## <a name="deploying-the-web-service"></a>Bereitstellen des Webdiensts

Führen Sie die folgenden Schritte aus, um die Management-OData-Webdienst bereitstellen.

1. Erstellen Sie ein Verzeichnis für Ihre-Anwendung unter IIS Web `WWWRoot` Verzeichnis.

2. Kopieren Sie die MOF-Schemadatei, die XML-Schema-Datei, die DLLs, die exportieren die [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) und [System.Management.Automation.Remoting.Pssessionconfiguration](/dotnet/api/System.Management.Automation.Remoting.PSSessionConfiguration) Schnittstellen und die Datei "Web.config" im Verzeichnis Anwendung.

3. Erstellen einer Site-ID.

4. Erstellen Sie und konfigurieren Sie einen app-Pool.

5. Konfigurieren der Authentifizierung für den Standort.

6. Konfigurieren der Firewall.

7. Starten Sie die Website.

Die folgenden Windows PowerShell-Skripts veranschaulichen, wie einen Management OData-Webdienst bereitgestellt wird.
