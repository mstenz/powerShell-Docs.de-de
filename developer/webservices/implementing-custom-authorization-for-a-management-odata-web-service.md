...
ms.locfileid: "56862586"
---
# <a name="implementing-custom-authorization-for-a-management-odata-web-service"></a><span data-ttu-id="09293-102">Implementieren der benutzerdefinierten Autorisierung für einen Management OData-Webdienst</span><span class="sxs-lookup"><span data-stu-id="09293-102">Implementing Custom Authorization for a Management OData web service</span></span>

<span data-ttu-id="09293-103">Mit dem Webdienst des Windows PowerShell erfordert eine von Drittanbietern zum Implementieren der [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) Windows PowerShell-Cmdlets verfügbar gemacht werden.</span><span class="sxs-lookup"><span data-stu-id="09293-103">Using the Windows PowerShell Web Service requires a third party to implement the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface to expose Windows PowerShell cmdlets.</span></span> <span data-ttu-id="09293-104">Diese Schnittstelle führt die benutzerautorisierung an den Webdienst.</span><span class="sxs-lookup"><span data-stu-id="09293-104">This interface performs user authorization to the web service.</span></span> <span data-ttu-id="09293-105">Nach den Code zum Implementieren der Schnittstelle zu schreiben, kompilieren Sie es in eine DLL, die in der Webanwendung verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="09293-105">After writing the code to implement the interface, you must compile it into a DLL to be used in the web application.</span></span>

## <a name="pass-through-authorization"></a><span data-ttu-id="09293-106">Pass-Through-Autorisierung</span><span class="sxs-lookup"><span data-stu-id="09293-106">Pass-through authorization</span></span>

<span data-ttu-id="09293-107">Die einfachste Methode zum Implementieren der [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) Schnittstelle ist eine Pass-Through-Implementierung, die alle Benutzer autorisiert.</span><span class="sxs-lookup"><span data-stu-id="09293-107">The simplest way to implement the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface is a pass-through implementation that authorizes all users.</span></span> <span data-ttu-id="09293-108">Dieses Beispiel enthält keine Sicherheit und s, die nur als ein Llustration wie die Schnittstelle implementiert.</span><span class="sxs-lookup"><span data-stu-id="09293-108">This example provides no security, and s provided only as an llustration of how to implement the interface.</span></span> <span data-ttu-id="09293-109">Eine Implementierung der [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) Schnittstelle muss zwei Methoden außer Kraft setzen: [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) und [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId).</span><span class="sxs-lookup"><span data-stu-id="09293-109">An implementation of the  [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface must override two methods: [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) and [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId).</span></span> <span data-ttu-id="09293-110">In diesem Beispiel die [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) gibt immer die **System.Security.Principal.WindowsIdentity** Objekt, mit dem aktuellen Benutzer verknüpft ist .</span><span class="sxs-lookup"><span data-stu-id="09293-110">In this example, the [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) always returns the **System.Security.Principal.WindowsIdentity** object associated with the current user.</span></span>
...
### <a name="role-based-authorization"></a><span data-ttu-id="09293-111">Rollenbasierte Autorisierung</span><span class="sxs-lookup"><span data-stu-id="09293-111">Role-based authorization</span></span>

<span data-ttu-id="09293-112">Das folgende Beispiel implementiert eine rollenbasierte Autorisierung-Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="09293-112">The following example implements a role-based authorization policy.</span></span> <span data-ttu-id="09293-113">Die Richtlinie wird in eine XML-Datei, die mit der Datei "Web.config" main Anwendungsverzeichnis befindet und MOF und XML-Mapping-Schema-Dateien definiert.</span><span class="sxs-lookup"><span data-stu-id="09293-113">The policy is defined in an XML file that resides in the main application directory with the web.config and MOF and XML mapping schema files.</span></span> <span data-ttu-id="09293-114">Informationen dazu, wie Sie die Schemadatei für die Autorisierung zu konfigurieren, finden Sie unter [Konfigurieren der rollenbasierten Autorisierung](./configuring-role-based-authorization.md).</span><span class="sxs-lookup"><span data-stu-id="09293-114">For information about how to configure the authorization schema file, see [Configuring Role-based Authorization](./configuring-role-based-authorization.md).</span></span> <span data-ttu-id="09293-115">Der erste Teil des Beispiels implementiert die [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) und [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId) -Methoden.</span><span class="sxs-lookup"><span data-stu-id="09293-115">The first part of the sample implements the [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) and [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId) methods.</span></span> <span data-ttu-id="09293-116">In diesem Fall die Schnittstellenmethoden, rufen Methoden in der `RbacSystem` -Klasse (unten definiert), die die eigentliche Arbeit der Überprüfung der Berechtigungen für den Benutzer zu tun.</span><span class="sxs-lookup"><span data-stu-id="09293-116">In this case, the interface methods call methods in the `RbacSystem` class (defined below) that do the actual work of checking the permissions for the user.</span></span>
...
<span data-ttu-id="09293-117">Das folgende Beispiel erstellt eine Klasse, die Autorisierungsrichtlinie für die XML-Datei analysiert.</span><span class="sxs-lookup"><span data-stu-id="09293-117">The following example creates a class that parses authorization policy in the XML file.</span></span>
...
```
 ...
 <span data-ttu-id="09293-118">Die folgenden Klassen stellen Gruppen und Benutzer dar.</span><span class="sxs-lookup"><span data-stu-id="09293-118">The following classes represent groups and users, respectively.</span></span>
