...
Dieses Beispiel zeigt, wie ein Cmdlet, das deklariert Parameter legt fest, gibt an, die Standardparameter festgelegt, und ein Eingabeobjekt akzeptieren geschrieben wird. Dieses Cmdlet ähnelt dem `Stop-Process` Cmdlet von Windows PowerShell 2.0 bereitgestellt werden.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>So erstellen Sie das Beispiel mithilfe von Visual Studio.

1. Navigieren Sie zum Ordner StopProcessSample04, mit dem Windows PowerShell 2.0 SDK installiert. Der standardmäßige Speicherort ist C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
...
- Hinzufügen eines Parameters, der das input-Objekt annimmt.

- Hinzufügen von Parametern zur Parametersätze

- Legen Sie den Standardparameter angeben.

## <a name="example"></a>Beispiel

Der folgende Code zeigt eine Implementierung von das Stop-Proc-Cmdlet, das Deklarieren von Parametersätzen, gibt an, die Standardparameter festgelegt, und ein Eingabeobjekt akzeptieren.

Dieses Beispiel zeigt das Eingabeobjekt, wie Parametersätze deklariert und wie an den Standard-Parametersatz verwenden.
