...
Dieses Beispiel zeigt eine vollständige Version des mit dem Get-Proc-Cmdlet.

## <a name="how-to-build-the-sample-using-visual-studio"></a>So erstellen Sie das Beispiel mithilfe von Visual Studio.

1. Öffnen Sie Windows Explorer, und navigieren Sie zum Verzeichnis "Samples" GetProcessSample05 Verzeichnis.

   Navigieren Sie zum Ordner GetProcessSample05, mit dem Windows PowerShell 2.0 SDK installiert. Der standardmäßige Speicherort ist C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. In der **erstellen** , wählen Sie im Menü **Projektmappe**.
   ...
   Die Bibliothek für das Beispiel wird in den Standardverzeichnissen \bin oder \bin\debug erstellt werden.
...
- Gibt an, dass Parameter als Eingaben über die Pipeline verwenden können. Die Eingabe kann verwendet werden, anhand eines Objekts oder einen Wert aus einer Eigenschaft eines Objekts, dessen Eigenschaftenname den Namen des Parameters übereinstimmt.
...
Dieses Beispiel zeigt, wie Sie ein Cmdlet zu erstellen, die eine Liste aller angegebenen Prozesse angezeigt wird.
