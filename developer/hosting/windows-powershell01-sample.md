...
ms.locfileid: "56856826"
---
# <a name="windows-powershell01-sample"></a><span data-ttu-id="4c445-102">Windows PowerShell01-Beispiel</span><span class="sxs-lookup"><span data-stu-id="4c445-102">Windows PowerShell01 Sample</span></span>

<span data-ttu-id="4c445-103">Dieses Beispiel zeigt, wie Sie mit einem [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) Objekt, das die Funktionalität von einem Runspace zu beschränken.</span><span class="sxs-lookup"><span data-stu-id="4c445-103">This sample shows how to use an [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) object to limit the functionality of a runspace.</span></span> <span data-ttu-id="4c445-104">Die Ausgabe dieses Beispiels wird veranschaulicht, wie beschränken Sie den Sprachmodus, der den Runspace, wie ein Cmdlet als privat markiert, hinzufügen und entfernen-Cmdlets und Anbieter, wie Sie einen Proxybefehl und vieles mehr hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="4c445-104">The output of this sample demonstrates how to restrict the language mode of the runspace, how to mark a cmdlet as private, how to add and remove cmdlets and providers, how to add a proxy command, and more.</span></span> <span data-ttu-id="4c445-105">Dieses Beispiel konzentriert sich auf den Runspace programmgesteuert zu beschränken.</span><span class="sxs-lookup"><span data-stu-id="4c445-105">This sample concentrates on how to restrict the runspace programmatically.</span></span> <span data-ttu-id="4c445-106">Skripterstellung Alternativen zum Einschränken des Runspaces enthalten die $ExecutionContext.SessionState.LanguageMode und PSSessionConfiguration-Befehle.</span><span class="sxs-lookup"><span data-stu-id="4c445-106">Scripting alternatives to restricting the runspace include the $ExecutionContext.SessionState.LanguageMode and PSSessionConfiguration commands.</span></span>

## <a name="requirements"></a><span data-ttu-id="4c445-107">Anforderungen</span><span class="sxs-lookup"><span data-stu-id="4c445-107">Requirements</span></span>

<span data-ttu-id="4c445-108">Dieses Beispiel ist die Windows PowerShell 2.0 erforderlich.</span><span class="sxs-lookup"><span data-stu-id="4c445-108">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="4c445-109">Veranschaulicht</span><span class="sxs-lookup"><span data-stu-id="4c445-109">Demonstrates</span></span>

<span data-ttu-id="4c445-110">Dieses Beispiel zeigt Folgendes:</span><span class="sxs-lookup"><span data-stu-id="4c445-110">This sample demonstrates the following:</span></span>

- <span data-ttu-id="4c445-111">Beschränken die Sprache durch Festlegen der [System.Management.Automation.Runspaces.Initialsessionstate.Languagemode](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.LanguageMode) Eigenschaft.</span><span class="sxs-lookup"><span data-stu-id="4c445-111">Restricting the language by setting the [System.Management.Automation.Runspaces.Initialsessionstate.Languagemode](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.LanguageMode) property.</span></span>

- <span data-ttu-id="4c445-112">Hinzufügen von Aliasen zu den anfänglichen Sitzungsstatus mithilfe einer [System.Management.Automation.Runspaces.Sessionstatealiasentry? Displayproperty = Fullname](/dotnet/api/System.Management.Automation.Runspaces.SessionStateAliasEntry) Objekt.</span><span class="sxs-lookup"><span data-stu-id="4c445-112">Adding aliases to the initial session state by using a [System.Management.Automation.Runspaces.Sessionstatealiasentry?Displayproperty=Fullname](/dotnet/api/System.Management.Automation.Runspaces.SessionStateAliasEntry) object.</span></span>

- <span data-ttu-id="4c445-113">Markieren Befehle als privat.</span><span class="sxs-lookup"><span data-stu-id="4c445-113">Marking commands as private.</span></span>

- <span data-ttu-id="4c445-114">Entfernen von Anbietern aus den anfänglichen Sitzungsstatus mithilfe der [System.Management.Automation.Runspaces.Initialsessionstate.Providers](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Providers) Eigenschaft.</span><span class="sxs-lookup"><span data-stu-id="4c445-114">Removing providers from the initial session state by using the [System.Management.Automation.Runspaces.Initialsessionstate.Providers](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Providers) property.</span></span>

- <span data-ttu-id="4c445-115">Entfernen von Befehlen aus den anfänglichen Sitzungsstatus mithilfe der [System.Management.Automation.Runspaces.Initialsessionstate.Commands](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Commands) Eigenschaft.</span><span class="sxs-lookup"><span data-stu-id="4c445-115">Removing commands from the initial session state by using the [System.Management.Automation.Runspaces.Initialsessionstate.Commands](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Commands) property.</span></span>

- <span data-ttu-id="4c445-116">Hinzufügen von Befehlen und Anbieter die [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) Objekt.</span><span class="sxs-lookup"><span data-stu-id="4c445-116">Adding commands and providers to the [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) object.</span></span>

## <a name="example"></a><span data-ttu-id="4c445-117">Beispiel</span><span class="sxs-lookup"><span data-stu-id="4c445-117">Example</span></span>

<span data-ttu-id="4c445-118">Dieses Beispiel zeigt verschiedene Möglichkeiten, um die Funktionalität von einem Runspace zu beschränken.</span><span class="sxs-lookup"><span data-stu-id="4c445-118">This sample shows several ways to limit the functionality of a runspace.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="4c445-119">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="4c445-119">See Also</span></span>

[<span data-ttu-id="4c445-120">Schreiben Sie eine Windows PowerShell-Hostanwendung</span><span class="sxs-lookup"><span data-stu-id="4c445-120">Writing a Windows PowerShell Host Application</span></span>](./writing-a-windows-powershell-host-application.md)