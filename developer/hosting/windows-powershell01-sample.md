...
Dieses Beispiel zeigt, wie Sie mit einem [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) Objekt, das die Funktionalität von einem Runspace zu beschränken. Die Ausgabe dieses Beispiels wird veranschaulicht, wie beschränken Sie den Sprachmodus, der den Runspace, wie ein Cmdlet als privat markiert, hinzufügen und entfernen-Cmdlets und Anbieter, wie Sie einen Proxybefehl und vieles mehr hinzufügen. Dieses Beispiel konzentriert sich auf den Runspace programmgesteuert zu beschränken. Skripterstellung Alternativen zum Einschränken des Runspaces enthalten die $ExecutionContext.SessionState.LanguageMode und PSSessionConfiguration-Befehle.
...
- Beschränken die Sprache durch Festlegen der [System.Management.Automation.Runspaces.Initialsessionstate.Languagemode](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.LanguageMode) Eigenschaft.

- Hinzufügen von Aliasen zu den anfänglichen Sitzungsstatus mithilfe einer [System.Management.Automation.Runspaces.Sessionstatealiasentry? Displayproperty = Fullname](/dotnet/api/System.Management.Automation.Runspaces.SessionStateAliasEntry) Objekt.

- Markieren Befehle als privat.

- Entfernen von Anbietern aus den anfänglichen Sitzungsstatus mithilfe der [System.Management.Automation.Runspaces.Initialsessionstate.Providers](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Providers) Eigenschaft.

- Entfernen von Befehlen aus den anfänglichen Sitzungsstatus mithilfe der [System.Management.Automation.Runspaces.Initialsessionstate.Commands](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Commands) Eigenschaft.

- Hinzufügen von Befehlen und Anbieter die [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) Objekt.

## <a name="example"></a>Beispiel

Dieses Beispiel zeigt verschiedene Möglichkeiten, um die Funktionalität von einem Runspace zu beschränken.
