...
## <a name="making-commands-private"></a>Machen Befehle private
 ...
 Sie können einen Befehl auch "private", vornehmen, indem Sie ihn festlegen des [System.Management.Automation.Commandinfo.Visibility](/dotnet/api/System.Management.Automation.CommandInfo.Visibility) Eigenschaft [System.Management.Automation.SessionStateEntryVisibility](/dotnet/api/System.Management.Automation.SessionStateEntryVisibility) **Private**. Die hostanwendung und andere Befehle können diesen Befehl aufrufen, aber der Benutzer die Anwendung kann nicht aus. Im folgenden Beispiel die [Get-ChildItem](/powershell/module/Microsoft.PowerShell.Management/Get-ChildItem) Befehl ist privat.
