...
- Erstellen einer Konsolenanwendung, verwendet diese Hostklassen, um eine interaktive Shell von Windows PowerShell zu erstellen.

- Erstellen einer `$profile` Variable und laden die folgenden Profile.

  - Aktueller Benutzer, der aktuelle host

  - Aktueller Benutzer, alle hosts

  - alle Benutzer, aktuelle host

  - alle Benutzer, alle hosts

- Implementieren der [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) Schnittstelle.

- Implementieren der [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) -Schnittstelle zur Unterstützung der interaktiven Remoting mit der [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) und [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) Cmdlets.
- Implementieren der [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) -Schnittstelle zur Unterstützung der interaktiven Remoting mit der [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) und [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) Cmdlets.

- Verwenden Sie die API mit einem Token versehen, zum farbigen Anzeigen von der Befehlszeile aus, wie er eingegeben wurde.

## <a name="example"></a>Beispiel

 In diesem Beispiel kann der Benutzer Befehle an einer Befehlszeile eingeben, werden diese Befehle verarbeitet und gibt dann die Ergebnisse.
...
## <a name="example"></a>Beispiel
 ...
 Der folgende Code ist die Implementierung der [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) -Klasse, die von dieser hostanwendung verwendet wird. Die Elemente, die nicht implementiert sind eine Ausnahme auslösen oder nichts zurückgeben.
...
## <a name="example"></a>Beispiel
 ...
 Der folgende Code ist die Implementierung der [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) -Klasse, die von dieser hostanwendung verwendet wird.
...
## <a name="example"></a>Beispiel
 ...
 Der folgende Code liest die Befehlszeile und die Farben den Text wie er eingegeben wird. Token hängen mit der [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) Methode.
