...
ms.locfileid: "56863746"
---
# <a name="host04-sample"></a><span data-ttu-id="6c2b6-102">Host04-Beispiel</span><span class="sxs-lookup"><span data-stu-id="6c2b6-102">Host04 Sample</span></span>

<span data-ttu-id="6c2b6-103">Dieses Beispiel zeigt, wie Sie eine interaktive, konsolenbasierte hostanwendung zu erstellen, die Befehle von der Befehlszeile aus liest, führt die Befehle aus und klicken Sie dann die Ergebnisse in der Konsole angezeigt wird.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="6c2b6-104">Diese Hostanwendung unterstützt auch das Anzeigen von Eingabeaufforderungen, die es den Benutzern ermöglichen, mehrere Auswahlmöglichkeiten anzugeben.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="6c2b6-105">Anforderungen</span><span class="sxs-lookup"><span data-stu-id="6c2b6-105">Requirements</span></span>

 <span data-ttu-id="6c2b6-106">Dieses Beispiel ist die Windows PowerShell 2.0 erforderlich.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="6c2b6-107">Veranschaulicht</span><span class="sxs-lookup"><span data-stu-id="6c2b6-107">Demonstrates</span></span>

- <span data-ttu-id="6c2b6-108">Erstellen eines benutzerdefinierten Hosts, deren Klassen leiten sich von, der [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) -Klasse, die [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) -Klasse, und die [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) Klasse.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="6c2b6-109">Erstellen einer Konsolenanwendung, verwendet diese Hostklassen, um eine interaktive Shell von Windows PowerShell zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="6c2b6-110">Erstellen einer `$profile` Variable und laden die folgenden Profile.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="6c2b6-111">Aktueller Benutzer, der aktuelle host</span><span class="sxs-lookup"><span data-stu-id="6c2b6-111">current user, current host</span></span>

  - <span data-ttu-id="6c2b6-112">Aktueller Benutzer, alle hosts</span><span class="sxs-lookup"><span data-stu-id="6c2b6-112">current user, all hosts</span></span>

  - <span data-ttu-id="6c2b6-113">alle Benutzer, aktuelle host</span><span class="sxs-lookup"><span data-stu-id="6c2b6-113">all users, current host</span></span>

  - <span data-ttu-id="6c2b6-114">alle Benutzer, alle hosts</span><span class="sxs-lookup"><span data-stu-id="6c2b6-114">all users, all hosts</span></span>

- <span data-ttu-id="6c2b6-115">Implementieren der [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) Schnittstelle.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="6c2b6-116">Beispiel</span><span class="sxs-lookup"><span data-stu-id="6c2b6-116">Example</span></span>

 <span data-ttu-id="6c2b6-117">In diesem Beispiel kann der Benutzer Befehle an einer Befehlszeile eingeben, werden diese Befehle verarbeitet und gibt dann die Ergebnisse.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="6c2b6-118">Beispiel</span><span class="sxs-lookup"><span data-stu-id="6c2b6-118">Example</span></span>

 <span data-ttu-id="6c2b6-119">Der folgende Code ist die Implementierung der [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) -Klasse, die von dieser hostanwendung verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="6c2b6-120">Die Elemente, die nicht implementiert sind eine Ausnahme auslösen oder nichts zurückgeben.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="6c2b6-123">Beispiel</span><span class="sxs-lookup"><span data-stu-id="6c2b6-123">Example</span></span>

 <span data-ttu-id="6c2b6-124">Der folgende Code ist die Implementierung der [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) -Klasse, die von dieser hostanwendung verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="6c2b6-125">Die Elemente, die nicht implementiert sind eine Ausnahme auslösen oder nichts zurückgeben.</span><span class="sxs-lookup"><span data-stu-id="6c2b6-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="6c2b6-126">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="6c2b6-126">See Also</span></span>

 [<span data-ttu-id="6c2b6-127">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="6c2b6-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="6c2b6-128">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="6c2b6-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="6c2b6-129">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="6c2b6-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
