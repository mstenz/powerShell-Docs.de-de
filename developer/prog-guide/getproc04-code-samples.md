...
|Language|Thema|
|--------------|-----------|
|C#|[GetProc04 (C#)-Codebeispiele](./getproc04-csharp-sample-code.md)|
|VB.NET|[GetProc04 Beispielcode (VB.NET)](./getproc04-vb-net-sample-code.md)|
