...
Gibt an, wie viele Zeichen, die die Daten von den linken Rand verschoben wurde. Dieses Element wird verwendet, wenn ein allgemeines Steuerelement zu definieren, das von allen Ansichten im die Formatierungsdatei verwendet werden kann.
