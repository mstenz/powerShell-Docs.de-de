...
Gibt an, wie viele Zeichen, die die erste Zeile der Daten auf der linken Seite verschoben wurde. Dieses Element wird verwendet, wenn ein allgemeines Steuerelement zu definieren, das von allen Ansichten im die Formatierungsdatei verwendet werden kann.
...
Wenn dieses Element angegeben ist, Sie können nicht angeben, die `FirstLineIndent` Element.
