...
- Definieren eine abgeleitete Anbieterklasse die [System.Management.Automation.Provider.Navigationcmdletprovider](/dotnet/api/System.Management.Automation.Provider.NavigationCmdletProvider) Klasse.

- Überschreiben der [System.Management.Automation.Provider.Navigationcmdletprovider.Moveitem*](/dotnet/api/System.Management.Automation.Provider.NavigationCmdletProvider.MoveItem) Methode zum Ändern des Verhaltens von der `Move-Item` -Cmdlet, damit der Benutzer Elemente von einem Speicherort in einen anderen zu verschieben. (Dieses Beispiel zeigt keine dynamischen Parameter zum Hinzufügen der `Move-Item` Cmdlet.)

- Überschreiben der [System.Management.Automation.Provider.Navigationcmdletprovider.Makepath*](/dotnet/api/System.Management.Automation.Provider.NavigationCmdletProvider.MakePath) Methode zum Ändern des Verhaltens von der `Join-Path` Cmdlet.
...
- Überschreiben der [System.Management.Automation.Provider.Navigationcmdletprovider.Getparentpath*](/dotnet/api/System.Management.Automation.Provider.NavigationCmdletProvider.GetParentPath) Methode.
...
Dieses Beispiel zeigt, wie Sie die erforderlichen so verschieben Sie Elemente in einer Microsoft Access-Daten, die grundlegenden Methoden überschreiben.
