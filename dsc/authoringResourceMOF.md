...
Die folgende MOF-Beispieldatei kann für eine benutzerdefinierte Websiteressource verwendet werden. Speichern Sie das Schema in einer Datei, um dieses Beispiel anzuwenden, und rufen Sie die Datei *Demo_IISWebsite.schema.mof* auf..
...
* Die Klasse, die Sie für die benutzerdefinierte Ressource definieren, muss abgeleitet sein von: `OMI_BaseResource`.
...
* `Values` schränkt die Werte, die der Eigenschaft zugewiesen werden können, auf die in `ValueMap` definierte Werteliste ein. Weitere Informationen finden Sie unter [ValueMap and Value Qualifiers](https://msdn.microsoft.com/library/windows/desktop/aa393965.aspx) (Die Qualifizierer „ValueMap“ und „Value“)..
