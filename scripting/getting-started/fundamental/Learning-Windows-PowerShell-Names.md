...
In vielen Fällen können Sie erkennen, was ein Befehl bewirkt, indem Sie seinen Namen lesen. Deshalb ist es meist offensichtlich, welcher Name für einen neuen Befehl verwendet werden sollte. Ein Befehl zum Herunterfahren eines Computers kann z.B. **Stop\-Computer** lauten. Ein Befehl zum Auflisten aller Computer in einem Netzwerk kann **Get\-Computer** heißen. Der Befehl zum Abrufen des Systemdatums lautet **Get\-Date**.
