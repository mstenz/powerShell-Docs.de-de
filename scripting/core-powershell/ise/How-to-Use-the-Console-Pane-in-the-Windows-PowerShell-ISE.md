...
-   Löschen des gesamten Texts im Konsolenbereich. Sie können auf der Symbolleiste auf das **Konsolenbereich löschen**-Symbol klicken, oder Sie führen den Befehl **Clear\-Host** oder dessen Alias **cls** aus, um den Konsolenbereich zu löschen..
