...
ms.locfileid: "72360089"
---
# <a name="stopprocesssample04-vbnet-sample-code"></a><span data-ttu-id="ddc20-102">StopProcessSample04-Codebeispiel (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="ddc20-102">StopProcessSample04 (VB.NET) Sample Code</span></span>

<span data-ttu-id="ddc20-103">Dies ist der umfassende VB.NET-Beispielcode für das Cmdlet "StopProc04 Sample".</span><span class="sxs-lookup"><span data-stu-id="ddc20-103">Here is the complete VB.NET sample code for the StopProc04 sample cmdlet.</span></span> <span data-ttu-id="ddc20-104">Dies ist der Code für das `Stop-Process`-Cmdlet, das unter [Hinzufügen von Parameter Sätzen zu einem Cmdlet](../cmdlet/adding-parameter-sets-to-a-cmdlet.md)beschrieben wird.</span><span class="sxs-lookup"><span data-stu-id="ddc20-104">This is the code for the `Stop-Process` cmdlet described in [Adding Parameter Sets to a Cmdlet](../cmdlet/adding-parameter-sets-to-a-cmdlet.md).</span></span> <span data-ttu-id="ddc20-105">Das Cmdlet "`Stop-Process`" ist so konzipiert, dass Prozesse beendet werden, die mit dem Cmdlet "Get-proc" abgerufen werden (siehe [Erstellen des ersten Cmdlets](../cmdlet/creating-a-cmdlet-without-parameters.md)).</span><span class="sxs-lookup"><span data-stu-id="ddc20-105">The `Stop-Process` cmdlet is designed to stop processes that are retrieved using the Get-Proc cmdlet (described in [Creating Your First Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md)).</span></span>

> [!NOTE]
> <span data-ttu-id="ddc20-106">Sie können die VB.net-Quelldatei (stopprocesssample04. vb) für dieses Cmdlet "Pause-proc" mithilfe der Laufzeitkomponenten Microsoft Windows Software Development Kit für Windows Vista und .NET Framework 3,0 herunterladen.</span><span class="sxs-lookup"><span data-stu-id="ddc20-106">You can download the VB.NET (stopprocesssample04.vb) source file for this Stop-Proc cmdlet using the Microsoft Windows Software Development Kit for Windows Vista and .NET Framework 3.0 Runtime Components.</span></span> <span data-ttu-id="ddc20-107">Anweisungen zum Herunterladen finden Sie unter [Installieren von Windows PowerShell und Herunterladen des Windows PowerShell SDK](/powershell/developer/installing-the-windows-powershell-sdk).</span><span class="sxs-lookup"><span data-stu-id="ddc20-107">For download instructions, see [How to Install Windows PowerShell and Download the Windows PowerShell SDK](/powershell/developer/installing-the-windows-powershell-sdk).</span></span>
>
> <span data-ttu-id="ddc20-108">Die heruntergeladenen Quelldateien sind in den **\<powershell-Beispielen >** Verzeichnis verfügbar.</span><span class="sxs-lookup"><span data-stu-id="ddc20-108">The downloaded source files are available in the **\<PowerShell Samples>** directory.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="ddc20-109">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="ddc20-109">See Also</span></span>

[<span data-ttu-id="ddc20-110">Windows PowerShell-Programmier Handbuch</span><span class="sxs-lookup"><span data-stu-id="ddc20-110">Windows PowerShell Programmer's Guide</span></span>](./windows-powershell-programmer-s-guide.md)

[<span data-ttu-id="ddc20-111">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="ddc20-111">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)