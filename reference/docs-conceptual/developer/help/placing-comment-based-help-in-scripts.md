...
In diesem Thema wird erläutert, wo Sie Kommentar basierte Hilfe für ein Skript platzieren können, damit das `Get-Help`-Cmdlet Skripts mit Skripts verknüpft und keine Funktionen enthält, die möglicherweise im Skript vorhanden sind.
