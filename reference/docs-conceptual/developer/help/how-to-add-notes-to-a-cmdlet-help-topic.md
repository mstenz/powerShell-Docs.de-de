...
Es gibt keine Beschränkung für die Anzahl von Notizen, die Sie zu einem Abschnitt mit Hinweisen hinzufügen können. Fügen Sie für jeden Hinweis dem Knoten \<maml: alertset > ein paar von \<maml: Alert > Tags hinzu. Der Inhalt der einzelnen Notiz wird innerhalb eines Satzes von \<maml: para > Tags hinzugefügt. Verwenden Sie leere \<maml: para > Tags für den Abstand.

Der folgende XML-Code zeigt einen \<maml: alertset-> Knoten mit zwei Notizen. Beachten Sie, dass jeder Hinweis über einen optionalen \<maml: Title > Tag verfügt (Titel können verwendet werden, um einen beliebigen Satz von \<maml: Alert > Tags zu gruppieren) und dass jede Notiz eine leere Zeile nach dem Inhalt für den Abstand enthält.
