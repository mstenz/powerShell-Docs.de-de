...
Sie können die Objekte, die vom N:Microsoft.PowerShell.ScheduledJob-Namespace verfügbar gemacht werden, verwenden, um einen geplanten Auftrag zu erstellen, den Zeitpunkt der Ausführung zu definieren und Ergebnisse zum abgeschlossenen Auftrag nach der Ausführung zu erhalten.

## <a name="triggering-the-job"></a>Auslösen des Auftrags

Der erste Schritt beim Erstellen eines geplanten Auftrags besteht darin, anzugeben, wann der Auftrag ausgeführt werden soll. Erstellen und konfigurieren Sie hierfür ein T:Microsoft.PowerShell.ScheduledJob.ScheduledJobTrigger-Objekt. Der folgende Code erstellt einen-Vorgang, der einen Auftrag für eine einmalige Ausführung von 20 Sekunden plant.
...
Anschließend erstellen Sie scheduledjobinvocationinfo-und scheduledjobdefinition-Objekte, um den Auftrag auszuführen. Dies wird im folgenden Code veranschaulicht.
...
Der folgende Code registriert den Auftrag beim Windows-Taskplaner.
...
## <a name="complete-code-example"></a>Code Beispiel vervollständigen
