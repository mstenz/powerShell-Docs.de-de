...
- Die Proxy Funktion wird dem anfänglichen Sitzungs Status hinzugefügt.
...
- Aufrufen des privaten Cmdlets und der Proxy Funktion mithilfe eines [System. Management. Automation. PowerShell](/dotnet/api/system.management.automation.powershell) -Objekts, um den eingeschränkten Runspace zu veranschaulichen.

## <a name="example"></a>Beispiel

Dadurch wird ein Proxy Befehl für ein privates Cmdlet erstellt, um einen eingeschränkten Runspace zu veranschaulichen.
