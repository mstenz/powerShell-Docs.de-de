...
In diesem Beispiel wird gezeigt, wie Aufträge beim Schreiben von Cmdlets unterstützt werden. Wenn Sie möchten, dass Benutzer das Cmdlet als Hintergrund Auftrag ausführen, müssen Sie den im folgenden Verfahren beschriebenen Code einschließen. Weitere Informationen zu Hintergrund Aufträgen finden Sie unter [Hintergrund Aufträge](./background-jobs.md).
...
Der folgende Beispielcode zeigt den Code für ein **Get-proc-** Cmdlet, das Prozesse intern oder mithilfe eines Hintergrund Auftrags abrufen kann.
