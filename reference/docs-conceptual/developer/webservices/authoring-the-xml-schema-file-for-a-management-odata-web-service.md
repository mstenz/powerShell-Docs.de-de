...
Der erste Teil der XML-Datei ordnet die in der MOF-Schema Datei definierten Ressourcen den URLs zu, die für den Zugriff verwendet werden. Das folgende Beispiel zeigt die Zuordnung.
...
## <a name="mapping-cmdlets-to-crud-operations"></a>Mapping von Cmdlets zu CRUD-Vorgängen

Anschließend geben Sie die Cmdlets an, die den CRUD-Vorgängen (erstellen, lesen, aktualisieren und löschen) entsprechen, die von den Ressourcen unterstützt werden. Im Management odata- [Ressourcen Zuordnungsschema](./resource-mapping-schema.md)werden die CRUD-Vorgänge wie folgt zugeordnet.
