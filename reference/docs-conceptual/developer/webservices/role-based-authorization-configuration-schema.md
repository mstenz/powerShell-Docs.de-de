...
ms.locfileid: "83564685"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="45ec6-102">Konfigurationsschema für die rollenbasierte Autorisierung</span><span class="sxs-lookup"><span data-stu-id="45ec6-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="45ec6-103">Das Beispiel " [ptauscht srolebasedplugins](https://go.microsoft.com/fwlink/?LinkId=243041) " verwendet XML-Dateien, um die Autorisierungs Richtlinie zu konfigurieren.</span><span class="sxs-lookup"><span data-stu-id="45ec6-103">The [PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="45ec6-104">Die folgende XSD definiert das Schema, das für diese Dateien verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="45ec6-104">The following XSD defines the schema used for these files.</span></span>
