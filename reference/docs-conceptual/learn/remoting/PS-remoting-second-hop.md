...
- [[MS-SFU]: Kerberos-Protokollerweiterungen: Service for-User und eingeschränkte Delegierung Protocol 1.3.2 S4U2proxy](https://msdn.microsoft.com/library/cc246079.aspx)
